...
#include "core/mem/static_buffer_mem.h"

#include <assert.h>
#include <stdio.h>

static void* static_buffer_mem_reserve(mem_t* interface, size_t* size)
{
...
static void static_buffer_mem_release(mem_t* interface, void* ptr, size_t size)
{
  (void)size;
  (void)ptr;
  static_buffer_mem_t* mem = (static_buffer_mem_t*)interface;
...
static void* static_buffer_mem_commit(mem_t* interface, void* ptr, size_t* size)
{
  (void)interface;
  (void)size;
  return ptr;
